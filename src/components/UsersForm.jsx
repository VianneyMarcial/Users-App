  ...
  return (
    <form className="user-form" onSubmit={handleSubmit(submit)}>
      <div className="input-container">
        <label htmlFor="first_name"><img src="./user-solid.svg" alt="" className="icons"/></label>
      ...
      <div className="input-container">
        <label htmlFor="email"><img src="./email.svg" alt="" className="icons"/></label>
        <input {...register("email")} type="text" id="email" className="info"/>
      </div>
      <div className="input-container">
        <label htmlFor="password"><img src="./candado.svg" alt="" className="icons"/></label>
        <input {...register("password")} type="text" id="password" className="info"/>
      </div>
      <div className="input-container">
        <label htmlFor="birthday"><img src="./cake.svg" alt="" className="icons"/></label>
